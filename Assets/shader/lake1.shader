    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_9659 = _Time;
                float2 node_3768 = (i.uv0+node_9659.g*float2(-0.1,-0.05));
                float3 node_8383 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_3768, _node_8178)));
                float2 node_8082 = ((i.uv0*0.5)+node_9659.g*float2(0.04,0.05));
                float3 _MainTex = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_8082, _node_8178)));
                float2 node_3577 = ((i.uv0*0.3)+node_9659.g*float2(-0.03,0.05));
                float3 node_6761 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_3577, _node_8178)));
                float2 node_9298 = ((i.uv0*0.25)+node_9659.g*float2(0.05,0));
                float3 node_9594 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_9298, _node_8178)));
                float2 node_8226 = ((i.uv0*0.1)+node_9659.g*float2(-0.03,-0.09));
                float3 node_9337 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_8226, _node_8178)));
                float2 node_7863 = (float4((i.uv0*0.08),(i.uv0*0.04))+node_9659.g*float2(0.03,0));
                float3 node_3496 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_7863, _node_8178)));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3x3 tangentTransform = float3x3( i.tangentDir, i.bitangentDir, i.normalDir);
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
                float4 node_2776 = _Time;
                float2 node_3768 = (i.uv0+node_2776.g*float2(-0.1,-0.05));
                float3 node_8383 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_3768, _node_8178)));
                float2 node_8082 = ((i.uv0*0.5)+node_2776.g*float2(0.04,0.05));
                float3 _MainTex = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_8082, _node_8178)));
                float2 node_3577 = ((i.uv0*0.3)+node_2776.g*float2(-0.03,0.05));
                float3 node_6761 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_3577, _node_8178)));
                float2 node_9298 = ((i.uv0*0.25)+node_2776.g*float2(0.05,0));
                float3 node_9594 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_9298, _node_8178)));
                float2 node_8226 = ((i.uv0*0.1)+node_2776.g*float2(-0.03,-0.09));
                float3 node_9337 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_8226, _node_8178)));
                float2 node_7863 = (float4((i.uv0*0.08),(i.uv0*0.04))+node_2776.g*float2(0.03,0));
                float3 node_3496 = UnpackNormal(tex2D(_node_8178,TRANSFORM_TEX(node_7863, _node_8178)));
float partZ = max(0,i.projPos.z - _ProjectionParams.g);
                float3 normalLocal = lerp(lerp((node_8383.rgb+(_MainTex.rgb*float3(-1,-1,1))),(node_6761.rgb+node_9594.rgb),saturate(((partZ-5.0)/10.0))),(node_9337.rgb+(node_3496.rgb*float3(-1,-1,1))),saturate(((partZ-5.0)/10.0)));
                float3 normalDirection = normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
